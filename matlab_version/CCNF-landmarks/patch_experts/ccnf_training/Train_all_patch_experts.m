...
[visiIndex, centres, patch_experts, imgs_used, norm_options] = ...
    AppendTraining(trainingLoc, frontalView, scaling, sigma, [], [], patch_experts, ratio_neg, num_samples, 'patches_view', 'frontal', varargin{:});
...
for i=1:numel(profile_views)
    ...
    [visiIndex, centres, patch_experts, imgs_used_profile] = ...
        AppendTraining(trainingLoc, profile_views(i), scaling, sigma, visiIndex, centres, patch_experts, ratio_neg, num_samples, 'patches_view', view_name, varargin{:});
